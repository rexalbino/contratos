...
?>
  <html>
   ...
   <a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons left">menu</i>menu</a>
        ...
        <br>
        <div class="container"> 
            <h3>Borrar contrato</h3>
            <p>Bienvenido <b><?php echo $row['nombre_usuario'].' '.$row['apellido_p'].' '.$row['apellido_m']  ?></b> al menu para borrar un contrato </p>
            <p>Para borrar al usuario presione el simbolo <i class='material-icons'>delete</i> </p>
		...
		?>
            ...
            <td><?php  echo "<a href=borrarcontrato.php?id={$row['id_contrato']}><i class='material-icons'>delete</i></a>";?></td>
    ...
    <div class="footer-copyright">
      <div class="container">
      Ver 0.5.1 Release  <i class="material-icons">stars</i> Designed by Abraham Duarte
      </div>
    </div>
  </footer>
